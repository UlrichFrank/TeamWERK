-- 018: Add 'honorar' to members.status CHECK constraint
-- Honorar members are external/honorary collaborators (e.g. paid coaches) who are
-- tracked in the system but have no club membership obligations.
