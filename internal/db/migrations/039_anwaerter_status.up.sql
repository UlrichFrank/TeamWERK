-- 039: Add 'anwaerter' to members.status CHECK constraint
-- Anwaerter are prospective players in a trial phase who are not yet full members
-- and have no user account. They participate via kader_extended_members.
