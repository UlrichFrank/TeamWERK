-- 018 down: Remove 'honorar' from members.status CHECK constraint
-- Existing honorar rows are set to 'aktiv' before removing the status value.
...
INSERT INTO members_new
    SELECT id, first_name, last_name, date_of_birth, pass_number, jersey_number, position,
           CASE WHEN status = 'honorar' THEN 'aktiv' ELSE status END,
