-- Rebuild kader without team_id column.
...
INSERT INTO kader_new SELECT id, season_id, age_class, gender, team_number, dedicated_birth_year, created_at, updated_at FROM kader;
DROP TABLE kader;
