...
var matrix = []endpointCase{
	...
	{method: "GET", path: "/api/admin/migrate-legacy/status", expected: exVorstandKassierer},
	{method: "GET", path: "/api/admin/migrate-legacy/data", expected: exVorstandKassierer},
	{method: "POST", path: "/api/admin/migrate-legacy/upload", expected: exVorstandKassierer},
