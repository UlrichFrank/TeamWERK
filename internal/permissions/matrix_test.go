...
var matrix = []endpointCase{
	...
	{method: "GET", path: "/api/training-series/{id}/unavailabilities", expected: exTrainer},
	{method: "POST", path: "/api/training-series/{id}/unavailabilities", expected: exTrainer},
	{method: "DELETE", path: "/api/training-series/{id}/unavailabilities/{uid}", expected: exTrainer},
	...
	{method: "GET", path: "/api/staffeln/{id}/kreuztabelle", expected: exAuth},
	{method: "GET", path: "/api/staffeln/{id}/tabellenverlauf", expected: exAuth},
