...
- [ ] 6.3 **Prod-Bereinigung — offen, gehört in den Rollout.** Dieselben zwei DELETEs auf `/var/lib/teamwerk/teamwerk.db` ausführen, **nach** dem Deploy des Code-Fixes (sonst erzeugt die alte Binary sofort neue Zeilen) und **nach** DB-Backup. Vorher Trefferzahl mit der Identifikations-Query aus 6.1 gegenprüfen und bestätigen lassen.
