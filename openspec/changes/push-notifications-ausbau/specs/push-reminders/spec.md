...
Das System SHALL zugeteilten Nutzern 48h vor einem Dienst eine Push Notification senden; optional auch eine E-Mail, wenn `email_enabled=1` für Kategorie `duty_reminders`.
