...
### Requirement: Freitext-Ort (location TEXT)
**Reason**: Ersetzt durch strukturierte venue_id FK — Freitext bot keine Navigation und war inkonsistent.
**Migration**: Bestehende location-Texte werden nicht migriert (Feld war kaum befüllt). Orte müssen neu als Venues angelegt werden.
