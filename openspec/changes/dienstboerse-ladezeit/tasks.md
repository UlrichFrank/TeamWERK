...
- [ ] 1.1 Vorher-Messung festhalten: SQL-Text der Assignee-Query aus `duties.Board` in eine unexportierte Funktion `boardAssigneesSQL(n int) string` ziehen (reines Refactoring, Form unverändert); verifiziert durch unverändert grünes `go test ./internal/duties/...`
