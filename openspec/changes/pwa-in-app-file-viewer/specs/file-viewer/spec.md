...
## Purpose
Dateien (Bilder, PDFs) innerhalb der TeamWERK-PWA anzeigen, ohne die App zu
verlassen — auch im Standalone-Modus auf iOS/Android, wo der Browser keine
eigene Navigation-UI bereitstellt.
