...
Ein Gesuch (`mitfahrten.typ='suche'`) gilt als **offen**, solange darauf **keine** `mitfahrt_paarungen` mit `status='confirmed'` existiert. Eine nur `pending`-Paarung zählt weiterhin als offen.
