...
Wenn der Partner-Eintrag keinen Treffpunkt gesetzt hat (`mitfahrten.treffpunkt` NULL oder leer), SHALL `partnerTreffpunkt` als leerer String (`""`) zurückgegeben werden — nicht weggelassen und nicht `null`.
