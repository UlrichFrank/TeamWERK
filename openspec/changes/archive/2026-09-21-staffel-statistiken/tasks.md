...
- [x] 7.2 `/verify-change` ausführen: Build, Test, Lint, Route→Tests, brand-Tokens, lucide-Icons, Migrationsnummer, `openspec validate`. Verifikation: alle Prüfungen grün.
