# member-csv-import-enhanced Specification

## Purpose
Erweiterung des Mitglieder-CSV-Imports um fehlende Felder, IBAN-Validierung, Email-Klassifizierung und einen Preview-Modus.
