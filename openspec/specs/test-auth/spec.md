# test-auth Specification

## Purpose
Fachliche Testabdeckung für die Authentifizierung: Login, Token-Rotation beim Refresh, Logout, Registrierung via Einladungstoken, Passwort-Reset (Anti-Enumeration + Session-Invalidierung) sowie Rollenvergabe und Nutzer-Löschung mit Cascade.
