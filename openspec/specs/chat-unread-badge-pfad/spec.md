# chat-unread-badge-pfad Specification

## Purpose
Der Weg, auf dem eine ungelesene Nachricht von der Zahl bis zum Klick sichtbar bleibt:
eine zentrale Berechnung der Ungelesen-Anteile und die Anzeigestellen, die sie tragen —
Nav-Modul-Header, Hinweis-Punkt am Hamburger und die Tabs auf `/chat`.
