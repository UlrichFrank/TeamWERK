# bwhv-spielberichte Specification

## Purpose
Abruf und Auswertung der offiziellen Spielberichte des Baden-Württembergischen
Handball-Verbands über die öffentliche Handball4All-Schnittstelle. Umfasst das
zeitlich abgeleitete Poll-Fenster, den `sGID`-gesteuerten Berichtsabruf, das
Parsing von Mannschaftsliste und Spielverlauf aus der PDF-Textebene samt
gestufter Kreuzprobe sowie die dauerhafte Ablage der Belege.

Der Zugriff braucht **keine Zugangsdaten** — Schnittstelle und Berichte sind
öffentlich. Die Credential-Disziplin aus `h4a-game-import` gilt hier nicht.
