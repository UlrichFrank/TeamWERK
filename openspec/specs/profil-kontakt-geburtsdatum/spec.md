# profil-kontakt-geburtsdatum Specification

## Purpose

Diese Spezifikation beschreibt die Capability `profil-kontakt-geburtsdatum`. (Automatisch normalisiert; Purpose bei Bedarf verfeinern.)
