# test-kader-handler Specification

## Purpose
Fachliche Testabdeckung für den Kader-Handler: AutoAssign nach DHB-Jahrgangsbracket (inkl. `dedicated_birth_year`) sowie MemberSuggestions mit optionalem Bracket-Filter.
