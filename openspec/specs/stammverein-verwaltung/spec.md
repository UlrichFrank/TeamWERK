# stammverein-verwaltung Specification

## Purpose
Verwaltung der Stammvereine (Mitgliedsvereine) und deren Bereitstellung für die Mitglieder-Auswahl. Die Zuordnung eines Mitglieds zu einem Stammverein bestimmt im Beitragslauf die Aktiv-Kategorie (`aktiv_mit` vs. `aktiv_ohne`).
