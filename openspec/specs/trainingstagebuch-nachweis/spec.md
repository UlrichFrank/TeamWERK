# trainingstagebuch-nachweis Specification

## Purpose

Optionaler Datei-Anhang je Trainingstagebuch-Eintrag: Upload (auch nachträglich), clientseitige
Bildkompression, serverseitige MIME-/Größen-Prüfung und zugriffsgeschützte Auslieferung über
einen eigenen Speicher (`TRAINING_DIARY_DIR`), getrennt von `internal/media`.
