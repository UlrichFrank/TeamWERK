...
make folien                  # Schulungsfolien aus docs/schulung/folien.txt (Text-DSL) → docs/schulung/folien/index.html
make schulung                # wie folien + Screenshots aus anonymisierter Kopie der lokalen DB — Howto: docs/schulung/HOWTO.md
